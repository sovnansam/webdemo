  ...
  const medicalDepartments = {
    en: {
      clinical: [
        ...
        { name: "Gastroenterology", href: "/gastrology" },
      ...
      surgical: [
        { name: "General Surgery", href: "#surgery" },
      ...
      specialized: [
        { name: "Pediatrics", href: "/pediatric" },
        { name: "OB-GYN", href: "/obgy" },
        { name: "ENT", href: "/ent" },
        { name: "Ophthalmology", href: "/ophthalmology" },
        { name: "Mental Health & Substance Abuse", href: "/#" },
      ],
      emergency: [
        { name: "Emergency Medicine", href: "#emergency-med" },
        { name: "ICU", href: "#icu" },
        { name: "Anesthesiology", href: "#anesthesia" },
        { name: "Blood Transfusion", href: "#" },
      ],
    },
    km: {
      clinical: [
        { name: "ជំងឺបេះដូង និង​ ព្យាបាលជំងឺមនុស្សចាស់", href: "/cardiology" },
        { name: "ផ្នែកប្រព័ន្ធរំលាយអាហារ", href: "/gastrology" },
        { name: "មជ្ឈមណ្ឌលឯកទេសជំងឺសួត", href: "/pulmonology" },
        { name: "ប្រព័ន្ធប្រសាទ", href: "/neurology" },
        { name: "ផ្នែកសើស្បែកនិងកាមរោគ", href: "/dermatology" },
        { name: "ជំងឺមហារីក", href: "/oncology" },
      ],
      surgical: [
        { name: "ផ្នែកវះកាត់ទូទៅ", href: "#surgery" },
        { name: "ផ្នែកវះកាត់ឆ្អឹងបាក់បែកនិងសន្លាក់", href: "#orthopedics" },
        {
          name: "ផ្នែកវះកាត់ប្រព័ន្ធប្រសាទ​ និង​ ខួរក្បាល",
          href: "#neurosurgery",
        },
        {
          name: "ផ្នែកវះកាត់មុខ-មាត់-ថ្គាម និងទន្តសាស្រ្ត",
          href: "/dentistry",
        },
        { name: "ផ្នែកវះកាត់តម្រងនោម", href: "/urology" },
      ],
      specialized: [
        { name: "ផ្នែកកុមារនិងទារក", href: "/pediatric" },
        { name: "ផ្នែកសម្ភពនិងរោគស្ត្រី", href: "/obgy" },
        { name: "ផ្នែកត្រចៀក-ច្រមុះ-បំពង់ក", href: "/ent" },
        { name: "ផ្នែកចក្ខុរោគ", href: "/ophthalmology" },
        { name: "ផ្នែកសុខភាពផ្លូវចិត្តនិងបំពានគ្រឿងញៀន", href: "/#" },
      ],
      emergency: [
        { name: "សង្គ្រោះបន្ទាន់", href: "#emergency-med" },
        { name: "ថែទាំធ្ងន់", href: "#icu" },
        { name: "សន្តំរ", href: "#anesthesia" },
        { name: "មជ្ឈមណ្ឌលលាងឈាម", href: "#" },
      ],
    },
  };
      ...
      <div className="max-w-9xl mx-auto px-3 sm:px-4 lg:px-6">
        <div className="flex justify-between items-center py-3 md:py-4">
          ...
          <nav className="hidden lg:flex space-x-6 xl:space-x-8 items-center">
            {t.navItems.map((item) =>
              item.dropdown ? (
                ...
                >
                  <button
                    className={`transition-colors duration-200 flex items-center cursor-pointer text-sm xl:text-base ${fontClasses.nav} ${
                      location.pathname === item.href ||
                      (item.dropdown &&
                        item.dropdown.some(
                          (dropItem) => location.pathname === dropItem.href,
                        ))
                        ? "text-blue-600"
                  ...
                  >
                    {item.name}
                    <svg
                      className={`w-3 h-3 md:w-4 md:h-4 ml-1 transition-transform duration-200 ${activeDropdown === "news-events" ? "rotate-180" : ""}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div
                    className={`absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 transition-all duration-300 ${
                      activeDropdown === "news-events"
                  ...
                  >
                    <div className="p-2">
                      <h3
                        className={`text-xs text-gray-500 mb-2 px-2 ${fontClasses.dropdown}`}
                      >
                        {t.newsEventsLabel}
                      </h3>
            ...
            >
              <button
                className={`text-gray-700 hover:text-blue-600 transition-colors duration-200 flex items-center cursor-pointer text-sm xl:text-base ${fontClasses.nav}`}
              >
                {t.departmentsLabel}
                <svg
                  className={`w-3 h-3 md:w-4 md:h-4 ml-1 transition-transform duration-200 ${activeDropdown === "departments" ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div
                className={`absolute top-full transform -translate-x-1/2 mt-2 w-[1050px] bg-white rounded-xl shadow-2xl border border-gray-200 transition-all duration-300 ${
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mb-6">
                    <h3
                      className={`text-lg text-gray-900 ${fontClasses.heading}`}
                    >
                      {t.departmentsTitle}
                    </h3>
                    <button
                  ...
                  <div className="grid grid-cols-4 gap-6">
                    ...
                    <div>
                      <h4
                        className={`text-sm text-gray-700 mb-3 flex items-center ${fontClasses.dropdown}`}
                      >
                        <span className="w-2 h-2 bg-blue-500 rounded-full mr-2"></span>
                        {t.clinicalDepartments}
                      </h4>
                      <div className="space-y-2">
                        {medicalDepartments[currentLanguage].clinical.map(
                          (dept) => (
                            <button
                              key={dept.name}
                            ...
                            >
                              ...
                              <div>
                                <div
                                  className={`text-gray-800 text-sm group-hover:text-blue-600 ${fontClasses.dropdown}`}
                                >
                                  {dept.name}
                                </div>
                                <div
                                  className={`text-xs text-gray-500 mt-0.5 ${fontClasses.dropdown}`}
                                >
                                  {dept.description}
                                </div>
                              </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {medicalDepartments[currentLanguage].surgical.map(
                          (dept) => (
                            <button
                              key={dept.name}
                              onClick={() => handleNavClick(dept.href)}
                            ...
                            >
                              ...
                              <div>
                                <div
                                  className={`text-gray-800 text-sm group-hover:text-green-600 ${fontClasses.dropdown}`}
                                >
                                  {dept.name}
                                </div>
                                <div
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {medicalDepartments[currentLanguage].specialized.map(
                          (dept) => (
                            <button
                              key={dept.name}
                              onClick={() => handleNavClick(dept.href)}
                            ...
                            >
                              ...
                              <div>
                                <div
                                  className={`text-gray-800 text-sm group-hover:text-purple-600 ${fontClasses.dropdown}`}
                                >
                                  {dept.name}
                                </div>
                                <div
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {medicalDepartments[currentLanguage].emergency.map(
                          (dept) => (
                            <button
                              key={dept.name}
                              onClick={() => handleNavClick(dept.href)}
                            ...
                            >
                              ...
                              <div>
                                <div
                                  className={`text-gray-800 text-sm group-hover:text-red-600 ${fontClasses.dropdown}`}
                                >
                                  {dept.name}
                                </div>
                                <div
            ...
            >
              <button
                className={`text-gray-700 hover:text-blue-600 transition-colors duration-200 flex items-center cursor-pointer text-sm xl:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-lg ${fontClasses.nav}`}
              ...
              >
                <div className="p-2">
                  <div className="px-3 pt-2 pb-1">
                    <h3
                      className={`text-xs uppercase tracking-wider font-semibold text-blue-600 ${fontClasses.dropdown}`}
                    >
                  ...
                  <div className="space-y-1 max-h-[400px] overflow-y-auto">
                    {medicalServices[currentLanguage].map((service, index) => (
                      <button
                        ...
                        className={`
              group/service relative w-full text-left px-3 py-2.5 rounded-lg 
              transition-all duration-150 cursor-pointer
              ${fontClasses.dropdown} text-sm
              ${
            ...
            `}
                      ...
                      >
                        ...
                        <div
                          className={`
              absolute bottom-1 left-3 right-3 h-0.5 bg-blue-600 rounded-full 
              transition-transform duration-500 origin-left
              ${location.pathname !== service.href && "scale-x-0 group-hover/service:scale-x-100"}
            `}
                        />
                      </button>
                    ))}
          ...
          <div className="hidden md:flex items-center space-x-3 lg:space-x-4 self-center">
            <a
              href="tel:+85595998953"
              className={`flex items-center text-gray-700 hover:text-blue-600 transition-colors duration-200 text-sm lg:text-base ${fontClasses.text}`}
            >
              <svg
          ...
          <div className="lg:hidden flex items-center space-x-3">
            ...
            >
              <span
                className={`w-5 h-0.5 md:w-6 md:h-0.5 bg-gray-700 transition-all ${isMenuOpen ? "rotate-45 translate-y-1.5 md:translate-y-2" : ""}`}
              />
              <span
                className={`w-5 h-0.5 md:w-6 md:h-0.5 bg-gray-700 transition-all ${isMenuOpen ? "opacity-0" : "opacity-100"}`}
              />
              <span
                className={`w-5 h-0.5 md:w-6 md:h-0.5 bg-gray-700 transition-all ${isMenuOpen ? "-rotate-45 -translate-y-1.5 md:-translate-y-2" : ""}`}
              />
        ...
        >
          <nav className="flex flex-col space-y-4 pt-4">
            {t.navItems.map((item) =>
              item.dropdown ? (
                ...
                <div key={item.name} className="border-b pb-3">
                  <h3
                    className={`text-gray-700 mb-2 text-sm ${fontClasses.nav} ${
                      location.pathname === item.href ||
                      (item.dropdown &&
                        item.dropdown.some(
                          (dropItem) => location.pathname === dropItem.href,
            ...
            <div className="border-t pt-4">
              <h3
                className={`text-gray-700 text-sm mb-3 ${fontClasses.heading}`}
              >
                {t.departmentsTitle}
              </h3>
              ...
              <div className="mb-4">
                <h4
                  className={`text-xs text-gray-600 mb-2 ${fontClasses.dropdown}`}
                >
                  {t.clinicalDepartments}
                </h4>
                <div className="grid grid-cols-2 gap-2">
                  {medicalDepartments[currentLanguage].clinical.map((dept) => (
                    ...
                    >
                      ...
                      <div>
                        <div
                          className={`text-gray-800 text-xs ${fontClasses.dropdown}`}
                        >
                          {dept.name}
                        </div>
                        <div
                          className={`text-gray-500 text-xs ${fontClasses.dropdown}`}
                        >
                          {dept.description}
                        </div>
                      </div>
            ...
            <div className="border-t pt-4">
              <h3
                className={`text-gray-500 text-xs mb-2 ${fontClasses.dropdown}`}
              >
                {t.medicalServicesTitle}
              </h3>
            ...
            <div className="border-t pt-3 space-y-2">
              <a
                href="tel:+85595998953"
                className={`flex items-center text-gray-700 hover:text-blue-600 py-2 transition-colors duration-200 text-sm ${fontClasses.text}`}
              >
                <svg
