...
// The API endpoint for fetching gastrology services
const API_URL = "API/departments/gastrology/gastrology_service.php";
...
const ServiceItem = ({ service, onClick, currentLanguage, index }) => {
  ...
  const sectionRoute = `/gastrology_section${sectionNumber}`;
  ...
  return (
    <motion.div
      ...
      tabIndex={0}
      className={`relative group mb-32 last:mb-0 focus:outline-none rounded-3xl transition-all duration-300 hover:shadow-2xl hover:shadow-teal-200/30 ${
        isSelected ? "bg-teal-50/40 shadow-2xl shadow-teal-200/30" : ""
      }`}
          ...
          >
            ...
            <motion.div
              ...
              className={`absolute top-6 ${
                ...
                isHovered
                  ? "scale-110 rotate-3 shadow-2xl shadow-teal-400/50"
                  : "shadow-lg"
              }`}
            >
              <motion.svg
          ...
          {service.category && (
            ...
            >
              <motion.span
                ...
                className={`px-3 py-1 text-xs font-semibold text-teal-700 bg-teal-100 rounded-full uppercase tracking-wider ${fontClass}`}
              >
                {service.category}
              </motion.span>
            </motion.div>
            ...
            <div className="flex-shrink-0">
              <motion.div
                ...
                className={`w-6 h-6 rounded-full flex items-center justify-center text-white font-bold text-sm ${
                  isHovered
                    ? "bg-gradient-to-br from-teal-600 to-teal-800 scale-110"
            ...
            >
              <motion.span
                ...
                className={`bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent bg-[length:200%_100%] bg-left ${
                  isHovered ? "from-teal-600 to-teal-500" : ""
                }`}
              >
              ...
              {detailedDescriptions.map((desc, i) => (
                ...
                >
                  <motion.span
                    ...
                    className="w-2 h-2 mr-3 mt-2 bg-teal-500 rounded-full flex-shrink-0"
                  ></motion.span>
                  <motion.p
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            (service.is_active === true ||
              ...
              >
                <motion.button
                  ...
                  className={`px-6 py-3 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg cursor-pointer ${fontClass}`}
                >
                  {currentLanguage === "en"
                    ? "View Full Details →"
                    : "មើលព័ត៌មានលម្អិត →"}
...
const gastrologyService = ({ currentLanguage }) => {
        ...
        <div className="max-w-md w-full text-center">
          <div className="w-24 h-24 mx-auto mb-8">
            <div className="relative w-full h-full">
              <div className="absolute inset-0 bg-gradient-to-br from-teal-100 to-teal-50 rounded-full animate-pulse"></div>
          ...
          <button
            ...
            className={`px-8 py-3 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-300 ${fontClass}`}
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 md:mb-20 max-w-6xl">
            <div className="inline-block mb-3">
              {/* Tagline/Category */}
              <p
                className={`text-sm font-semibold uppercase tracking-widest text-teal-600 ${fontClass}`}
              >
...
export default gastrologyService;