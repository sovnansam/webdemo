...
const API_URL = "API/departments/gastrology/gastrology_section10.php";
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <motion.div
          ...
          className="rounded-full h-16 w-16 border-t-2 border-b-2 border-red-500"
        />
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleBack}
            className={`px-8 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold rounded-xl cursor-pointer ${fontClass}`}
          >
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="py-4">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                onClick={handleBack}
                className={`group flex items-center gap-2 px-4 py-3 rounded-xl hover:bg-red-50 transition-all duration-200 cursor-pointer border border-red-100 bg-white/80 shadow-sm hover:shadow-md ${fontClass}`}
              >
                <motion.div
                  animate={{ x: [0, -2, 0] }}
                  transition={{
...
export default GastrologySection10;
