...
const API_URL = "API/departments/gastrology/gastrology_hero.php";
...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=Gastrology+Image";
  }
  if (imagePath.startsWith("http")) return imagePath;
  if (imagePath.startsWith("/")) return imagePath.substring(1);
  return `API/departments/gastrology/${imagePath}`;
};
        ...
        <div className="text-center p-6">
          ...
          {error && (
            <button
              ...
              className={`px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium rounded-lg transition-colors mt-2 ${fontClass}`}
            >
              {langContent.retry}
            </button>
          )}
  ...
  const content = {
    en: {
      ...
      schedule: {
        ...
        Radiation: {label: "Radiation therapy", days: "Monday - Friday",
          hours: "7:35 AM - 5:00 PM",},
    ...
    km: {
      ...
      schedule: {
       ...
       Radiation: {
          ...
          days: "ថ្ងៃច័ន្ទ - ថ្ងៃសុក្រ",
          hours: "៧:៣៥ ្រឹក - ៥:០០ ល្ងាច",
        },
        contact: { label: "ទំនាក់ទំនង៖", number: " +(៩៩) ៧៦​ ៨០០ ស៨០៨" },
      },
    },
  };
  ...
  return (
    <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-3xl p-6 border border-gray-200 shadow-xl h-full flex flex-col">
      <div className="flex items-center justify-between">
        ...
        <div className="w-10 h-10 -mt-20 rounded-full bg-gradient-to-r from-teal-500 to-teal-600 flex items-center justify-center shadow-md">
          <svg
      ...
      <div className="space-y-4 flex-grow">
        {[
          ...
          {
            ...langContent.schedule.Radiation,
            icon: "🚨",
            color: "from-teal-500 to-teal-600",
          },
        ].map((item, index) => (
...
// ==========================================
// 4. MAIN GASTROLOGY HERO COMPONENT (NEW LAYOUT)
// ==========================================

const GastrologyHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      title: "Department Of ",
      titleHighlight: "Gastrology",
      description:
        "Our Gastrology Department provides comprehensive care for digestive system disorders, utilizing advanced diagnostic technologies and evidence-based treatments. We specialize in the prevention, diagnosis, and management of gastrointestinal conditions, offering both medical and surgical interventions to ensure optimal digestive health.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "ក្រពះពោះវៀន",
      description:
        "នាយកដ្ឋានជំងឺមហ្សេវាកម្មរបស់យើងប្ដេជ្ញាផ្ដល់ការថែទាំជំងឺមហ្សេវាកម្មដ៏ទូលំទូលាយជាមួយការធ្វើរោគវិនិច្ឆ័យ និងការព្យាបាលបង្ការមុន ដល់ការថែទាំសរសៃឈាមបេះដូងនិងសេវាកម្មយ៉ាងទូលំទូលាយសម្រាប់ជំងឺបេះដូងដ៏ទូលំទូលាយរួមទាំងការវះកាត់បេះដូងអេឡិចត្រូសរីរវិទ្យា ការគ្រប់គ្រងជំងឺខ្សោយបេះដូងកម្រិតខ្ពស់និងការវះកាត់សរសៃឈាមបេះដូងបេះដូងនិងសេវាកម្មដែលយើងផ្ត់ជូនរួមមាន:",
    },
  };
  ...
  return (
    <div className="relative bg-gradient-to-b from-gray-50 via-white to-gray-50 overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 w-64 h-64 bg-gradient-to-br from-teal-50 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-teal-50 to-transparent rounded-full blur-3xl"></div>
            ...
            <div className="space-y-6 mb-12">
              <div className="inline-flex items-center gap-3">
                <div className="relative">
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-teal-600 rounded-full"></div>
                </div>
                <span
                  className={`text-sm font-semibold tracking-wider uppercase text-teal-600 ${fontClass}`}
                >
                  {currentLanguage === "en"
                    ? "Specialized Center"
                    : "មជ្ឈមណ្ឌលឯកទេស"}
              ...
              >
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 bg-gradient-to-r from-teal-600 to-teal-700 bg-clip-text text-transparent">
                    {langContent.titleHighlight}
                  </span>
                  <span className="absolute -bottom-2 left-0 w-full h-2 bg-teal-100 blur-sm rounded-full"></span>
                </span>
              </h1>

              <div className="w-24 h-1.5 bg-gradient-to-r from-teal-500 to-teal-600 rounded-full"></div>
            </div>
