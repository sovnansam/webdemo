...
import OphthalmologyHero from "./ophthalmology_hero";
import OphthalmologyService from "./ophthalmology_service";
import OphthalmologySection1 from "./OphthalmologySection1";
import OphthalmologySection2 from "./OphthalmologySection2";
import OphthalmologySection3 from "./OphthalmologySection3";
import OphthalmologySection4 from "./OphthalmologySection4";
import OphthalmologySection5 from "./OphthalmologySection5";
import OphthalmologySection6 from "./OphthalmologySection6";
import OphthalmologySection7 from "./OphthalmologySection7";
import OphthalmologySection8 from "./OphthalmologySection8";
import OphthalmologySection9 from "./OphthalmologySection9";
import OphthalmologySection10 from "./OphthalmologySection10";
...
const Ophthalmology = () => {
  ...
  return (
    <>
      <OphthalmologyHero currentLanguage={currentLanguage} />
      <OphthalmologyService currentLanguage={currentLanguage} />
