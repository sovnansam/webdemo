...
const API_URL = "API/departments/urology/urology_hero.php";
...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=Urology+Image";
  }
...
const CompactImageSlideshow = ({ currentLanguage }) => {
  ...
  const content = {
    ...
    km: {
      ...
      gallery: "វិចិត្រសាលជំងឺផ្លេកខាងក្នុង",
    },
  };
...
// ==========================================
// 4. MAIN UROLOGY HERO COMPONENT (NEW LAYOUT)
// ==========================================

const UrologyHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      title: "Department Of ",
      titleHighlight: "Urology",
      description:
        "Our Urology Department is dedicated to providing comprehensive urological care with a patient-centered approach. We specialize in urinary tract and male reproductive system health, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "ជំងឺផ្លេកខាងក្នុង",
      description:
        "នាយកដ្ឋានជំងឺផ្លេកខាងក្នុងរបស់យើងប្ដេជ្ញាផ្ដល់ការថែទាំជំងឺផ្លេកខាងក្នុងដ៏ទូលំទូលាយជាមួយនឹងវិធីសាស្រ្តផ្តោតលើអ្នកជំងឺ។ យើងមានជំនាញក្នុងការថែទាំសុខភាពផ្លូវទឹកនោម និងប្រព័ន្ធបង្កើតកូនរបស់បុរស ដោយប្រើប្រាស់បច្ចេកវិទ្យាវេជ្ជសាស្ត្រទំនើប និងការព្យាបាលដែលមានមូលដ្ឋានលើភស្តុតាង។",
    },
  };
