...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=Pediatric+Image";
  }
...
const CompactImageSlideshow = ({ currentLanguage }) => {
  ...
  const content = {
    ...
    km: {
      ...
      gallery: "វិចិត្រសាលមន្ទីរពេទ្យកុមារ",
    },
  };
  ...
  const content = {
    en: {
      ...
      schedule: {
        ...
        therapy: {label: "Pediatric Therapy", days: "Monday - Friday",
          hours: "7:35 AM - 5:00 PM",},
...
// ==========================================
// 4. MAIN PEDIATRIC HERO COMPONENT (NEW LAYOUT)
// ==========================================

const PediatricHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      title: "Department Of ",
      titleHighlight: "Pediatric",
      description:
        "Our Pediatric Department is dedicated to providing comprehensive healthcare for children with a patient-centered approach. We specialize in the diagnosis, treatment, and management of various pediatric conditions, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
