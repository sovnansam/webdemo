...
const API_URL = "API/departments/Dermatology/Dermatology_hero.php";
...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=Dermatology+Image";
  }
...
// ==========================================
// 4. MAIN Dermatology HERO COMPONENT (NEW LAYOUT)
// ==========================================

const DermatologyHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      ...
      description:
        "Our Dermatology Department is dedicated to providing comprehensive dermatological care with a patient-centered approach. We specialize in the diagnosis, dermatological treatment, and management of various types of dermatological, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "សើរស្បែក",
      description:
