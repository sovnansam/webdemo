...
// The API endpoint for fetching OBGY services
const API_URL = "API/departments/obgyn/obgyn_service.php";
...
const getImageUrl = (imagePath) => {
  ...
  return `API/departments/obgyn/${imagePath}`;
};
...
const ServiceItem = ({ service, onClick, currentLanguage, index }) => {
  ...
  const isSelected =
    sessionStorage.getItem("Obgy_service_last_selected") === String(index);
  const sectionNumber = Math.min(index + 1, 10);
  const sectionRoute = `/Obgy_section${sectionNumber}`;
...
const ObgyService = ({ currentLanguage }) => {
  ...
  const content = {
    en: {
      title: "OBGY Services",
      subtitle:
        "Comprehensive obstetric and gynecological care with advanced diagnostics and treatments",
      ...
      cta: {
        ...
        description: "Schedule a consultation with our expert OBGY team",
        paragraph: "Schedule a consultation with our expert OBGY team",
    ...
    km: {
      title: "សេវាកម្មស្ត្រីពេទ្យ និងសុវណ្ណគតិ",
      subtitle:
        "ការថែទាំស្ត្រីពេទ្យ និងសុវណ្ណគតិទូលំទូលាយជាមួយការធ្វើរោគវិនិច្ឆ័យ និងការព្យាបាលឆ្នើម",
      tagline: "ការថែទាំសុខភាពស្ត្រីដោយអ្នកជំនាញ",
      stats: {
      ...
      cta: {
        ...
        description: "កក់ណាត់ពិគ្រោះជាមួយក្រុមអ្នកជំនា៍ស្ត្រីពេទ្យ និងសុវណ្ណគតិរបស់យើង",
        paragraph: "កក់ណាត់ពិគ្រោះជាមួយក្រុមអ្នកជំនាញស្ត្រីពេទ្យ និងសុវណ្ណគតិរបស់យើង",
        button: "កក់ណាត់",
      },
      error: {
  ...
  useEffect(() => {
    const fetchServices = async () => {
      ...
      try {
        ...
        console.error("Error fetching OBGY services:", err);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 md:mb-20 max-w-6xl">
            ...
            >
                       {" "}
              {currentLanguage === "en"
                ? "The Obstetrics and Gynecology Department located in Khmer-Soviet Friendship Hospital, provides a wide range of services for women's health, from routine gynecological care and prenatal services to advanced treatments for complex conditions. Our comprehensive OBGY services include:."
                : "នាយកដ្ឋានស្ត្រីពេទ្យ និងសុវណ្ណគតិ មានទីតាំងនៅក្នុងមន្ទីរពេទ្យមិត្តភាពខ្មែរ-សូវៀត ផ្តល់សេវាកម្មយ៉ាងទូលំទូលាយសម្រាប់សុខភាពស្ត្រី តាំងពីការថែទាំសុវណ្ណគតិធម្មតា និងសេវាកម្មមុនឆ្នាំទារក ដល់ការព្យាបាលជំងឺស្មុគស្មាញកម្រិតខ្ពស់។ សេវាកម្មស្ត្រីពេទ្យ និងសុវណ្ណគតិទូលំទូលាយរបស់យើងរួមមាន:"}
                     {" "}
            </p>
