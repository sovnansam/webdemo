...
const API_URL = "API/departments/obgyn/obgyn_hero.php";
...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=OBGY+Image";
  }
...
const CompactImageSlideshow = ({ currentLanguage }) => {
  ...
  const content = {
    ...
    km: {
      ...
      gallery: "វិចិត្រសាលស្ត្រីពេទ្យ និងសុវណ្ណគតិ",
    },
  };
...
// ==========================================
// 4. MAIN OBGY HERO COMPONENT (NEW LAYOUT)
// ==========================================

const ObgyHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      ...
      titleHighlight: "OBGY",
      description:
        "Our OBGY Department is dedicated to providing comprehensive obstetric and gynecological care with a patient-centered approach. We specialize in women's health, prenatal care, and management of various gynecological conditions, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "ស្ត្រីពេទ្យ និងសុវណ្ណគតិ",
      description:
        "នាយកដ្ឋានស្ត្រីពេទ្យ និងសុវណ្ណគតិរបស់យើងប្ដេជ្ញាផ្ដល់ការថែទាំស្ត្រីពេទ្យ និងសុវណ្ណគតិដ៏ទូលំទូលាយជាមួយនឹងវិធីសាស្រ្តផ្តោតលើអ្នកជំងឺ។ យើងមានជំនាញក្នុងការថែទាំសុខភាពស្ត្រី ការថែទាំមុនឆ្នាំទារក និងការគ្រប់គ្រងជំងឺសុវណ្ណគតិផ្សេងៗ ដោយប្រើប្រាស់បច្ចេកវិទ្យាវេជ្ជសាស្ត្រទំនើប និងការព្យាបាលដែលមានមូលដ្ឋានលើភស្តុតាង។",
    },
  };
