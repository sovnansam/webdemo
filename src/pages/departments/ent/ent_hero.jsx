...
const API_URL = "API/departments/ent/ent_hero.php";
...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=ENT+Image";
  }
...
const CompactImageSlideshow = ({ currentLanguage }) => {
  ...
  const content = {
    ...
    km: {
      ...
      gallery: "វិចិត្រសាលត្រចៀក ច្រមុះ និងក",
    },
  };
...
// ==========================================
// 4. MAIN ENT HERO COMPONENT (NEW LAYOUT)
// ==========================================

const EntHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      ...
      titleHighlight: "ENT",
      description:
        "Our ENT Department is dedicated to providing comprehensive ear, nose, and throat care with a patient-centered approach. We specialize in diagnosing and treating conditions of the ear, nose, and throat, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "ត្រចៀក ច្រមុះ និងក",
      description:
        "នាយកដ្ឋានត្រចៀក ច្រមុះ និងករបស់យើងប្ដេជ្ញាផ្ដល់ការថែទាំត្រចៀក ច្រមុះ និងកដ៏ទូលំទូលាយជាមួយនឹងវិធីសាស្រ្តផ្តោតលើអ្នកជំងឺ។ យើងមានជំនាញក្នុងការធ្វើរោគវិនិច្ឆ័យ និងព្យាបាលជំងឺត្រចៀក ច្រមុះ និងក ដោយប្រើប្រាស់បច្ចេកវិទ្យាវេជ្ជសាស្ត្រទំនើប និងការព្យាបាលដែលមានមូលដ្ឋានលើភស្តុតាង។",
    },
  };
