...
const API_URL = "API/departments/dentistry/dentistry_hero.php";
...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=Dentistry+Image";
  }
...
// ==========================================
// 4. MAIN DENTISTRY HERO COMPONENT (NEW LAYOUT)
// ==========================================

const DentistryHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      ...
      description:
        "Our Dentistry Department is dedicated to providing comprehensive dental care with a patient-centered approach. We specialize in diagnosing and treating dental conditions, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "ជំងឺធ្មេញ",
      description:
        "នាយកដ្ឋានជំងឺធ្មេញរបស់យើងប្ដេជ្ញាផ្ដល់ការថែទាំធ្មេញដ៏ទូលំទូលាយជាមួយនឹងវិធីសាស្រ្តផ្តោតលើអ្នកជំងឺ។ យើងមានជំនាញក្នុងការធ្វើរោគវិនិច្ឆ័យ និងព្យាបាលជំងឺធ្មេញ ដោយប្រើប្រាស់បច្ចេកវិទ្យាវេជ្ជសាស្ត្រទំនើប និងការព្យាបាលដែលមានមូលដ្ឋានលើភស្តុតាង។",
    },
  };
