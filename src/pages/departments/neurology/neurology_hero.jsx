...
const API_URL = "API/departments/Neurology/Neurology_hero.php";
...
const getImageUrl = (imagePath) => {
  if (!imagePath || imagePath === "null" || imagePath === "undefined") {
    return "https://placehold.co/800x600/1a1a1a/333333?text=Neurology+Image";
  }
  ...
  const content = {
    en: {
      ...
      schedule: {
        ...
        therapy: {label: "therapy therapy", days: "Monday - Friday",
          hours: "7:35 AM - 5:00 PM",},
...
// ==========================================
// 4. MAIN NEUROLOGY HERO COMPONENT (NEW LAYOUT)
// ==========================================

const NeurologyHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      title: "Department Of ",
      titleHighlight: "Neurology",
      description:
        "Our Neurology Department is dedicated to providing comprehensive neurological care with a patient-centered approach. We specialize in the diagnosis, treatment, and management of various types of neurological, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "ប្រព័ន្ធប្រសាទ",
      description:
        "នាយកដ្ឋានជំងឺមហារីករបស់យើងប្ដេជ្ញាផ្ដល់ការថែទាំជំងឺមហារីកដ៏ទូលំទូលាយជាមួយនឹងវិធីសាស្រ្តផ្តោតលើអ្នកជំងឺ។ យើងមានជំនាញក្នុងការធ្វើរោគវិនិច្ឆ័យ ការព្យាបាល និងការគ្រប់គ្រងជំងឺមហារីកប្រភេទផ្សេងៗ ដោយប្រើប្រាស់បច្ចេកវិទ្យាវេជ្ជសាស្ត្រទំនើប និងការព្យាបាលដែលមានមូលដ្ឋានលើភស្តុតាង។",
    },
  };
