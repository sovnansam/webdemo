...
const API_URL = "API/departments/oncology/oncology_hero.php";
...
const OncologyHero = ({ currentLanguage, onLanguageChange }) => {
  const fontClass = getFontClass(currentLanguage);
  ...
  const heroContent = {
    en: {
      ...
      description:
        "Our Oncology Department is dedicated to providing comprehensive cancer care with a patient-centered approach. We specialize in the diagnosis, treatment, and management of various types of cancer, utilizing advanced medical technologies and evidence-based therapies.",
    },
    km: {
      title: "ផ្នែក",
      titleHighlight: "មហារីក",
      description:
