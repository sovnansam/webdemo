...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React30.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React30.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React30.useMemo(() => storageManager?.({
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JX7JE2KU.js.map
